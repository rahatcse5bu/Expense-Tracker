...
const color = Number(transaction.amount)>=0? 'green' : 'red';
...
<div className={`grid grid-cols-2 gap-20 bg-blue-950 justify-between items-center text-white border-r-4 ${colorClass} px-4 py-2`}>
